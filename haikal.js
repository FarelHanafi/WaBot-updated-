...
m.reply('*Rusak Bodoh !! Yang Bener Contoh : Yoapk Rein WA*')
}
...
m.reply('*Rusak Bodoh !! Yang Bener Contoh : Yozip Rein WA*')
}
...
m.reply('*Rusak Bodoh !! Yang Bener Contoh : Yopdf Rein WA*')
}
...
reply(`Wait 1-24 Jam an untuk proses banned dari bot dan tunggu ±30 Detik an untuk melihat balasan email dari WhatsApp tuan Rein🥺🙏`)
...
reply(`Wait 1-24 Jam an untuk proses unbanned dari bot dan tunggu ±30 Detik an untuk melihat balasan email dari WhatsApp tuan Rein🥺🙏`)
await loading(90000)
let payload = String(res.data)
if (payload.includes(`"payload":true`)) {
reply(`##- WhatsApp Support -##
...
"message": "",
"orderTitle": "Rein WA",
"sellerJid": "62881026950162@s.whatsapp.net",
...
"businessOwnerJid": "62881026950162@s.whatsapp.net"
}
}), { userJid: from, quoted:kalgans})
...
console.log(`[${new Date().toLocaleTimeString()}] Spam (SMS) BY Rein WA MODS`);
});
}
...
case 'horrorblood':
case 'thunder':
if (args.length == 0) return reply(`Example: ${prefix + command} Rein WA`)
await loading()
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
await loading()
 if (!text) throw `Example : ${prefix + command} Rein WA, 7, 7, 2005, Putri, 16, 11, 2004`
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
await loading()
 if (!text) throw `Example : ${prefix + command} Rein WA Hw`
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
await loading()
 if (!text) throw `Example : ${prefix + command} Rein WA, 7, 7, 2005`
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
await loading()
 if (!text) throw `Example : ${prefix + command} Rein WA|Putri`
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
await loading()
 if (!text) throw `Example : ${prefix + command} Rein WA, 1, 2005\n\nNote : ${prefix + command} Nama, gender, tahun lahir\nGender : 1 untuk laki-laki & 2 untuk perempuan`
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
await loading()
 if (!text) throw `Example : ${prefix + command} Rein WA, 7, 7, 2005, 2022\n\nNote : ${prefix + command} Nama, tanggal lahir, bulan lahir, tahun lahir, untuk tahun`
...
teksoooo = `│\n└────────────⭓\n\n*Total ada : ${docunye.length} \n\n Contoh 1 : sendpdf Rein WA + sambil reply pesan target* \n\n Contoh 2 : yopdf Rein WA`
m.reply(teksoooo)
}
break
//=================================================//
...
teksooooo = `│\n└────────────⭓\n\n*Total ada : ${zipnye.length} \n\n Contoh 1 : sendzip Rein WA + sambil reply pesan target* \n\n Contoh 2 : yozip Rein WA`
m.reply(teksooooo)
}
break
//=================================================//
...
teksoooooo = `│\n└────────────⭓\n\n*Total ada : ${apknye.length} \n\n Contoh 1 : sendapk Rein WA + sambil reply pesan target* \n\n Contoh 2 : yoapk Rein WA`
m.reply(teksoooooo)
}
break
//=================================================//
